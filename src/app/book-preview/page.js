...
const BookPreview = () => {
          ...
          <div className="max-w-4xl mx-auto p-4 md:p-8 lg:p-12 rounded-xl md:rounded-2xl shadow-xl bg-gradient-to-r from-[#ffe4ec] via-[#fdfdfd] to-[#e0f3ff] flex flex-col gap-6 md:gap-8 lg:gap-10">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-gray-600 max-w-3xl">
                Use this preview to see how your book will look. Carefully
                review margins, layout, and content before continuing. Your book
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 mt-8">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg mb-8">
                ...
                <ol className="list-decimal pl-6 text-gray-700 space-y-2">
                  ...
                  <li>
                    Confirm that all chapters and sections are in the right
                    order
                  </li>
  ...
  return (
    <>
      <Suspense fallback={<div>Loading book preview...</div>}>
